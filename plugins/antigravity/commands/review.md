...
Run an agy code review against your current work.
...
- `/antigravity:review` does not support extra focus text. Use `/antigravity:adversarial-review` when you want to challenge a specific decision or risk area.
...
- After launching the command, tell the user: "Antigravity review started in the background. Check `/antigravity:status` for progress."
